...
def vis_pose_result(image, pose_results, thickness):
    data_numpy = image
...
def main():
    ...
    parser.add_argument(
        ...
        'Default not saving the visualization videos.')
    parser.add_argument(
    ...
    if args.out_video_root == '':
        ...
        out_file = os.path.join(args.out_video_root, f'vis_{os.path.basename(args.video)}')
