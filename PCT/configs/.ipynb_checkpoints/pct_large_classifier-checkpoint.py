_base_ = ['C:/Users/ngovi/Desktop/PCT/configs/mpii.py']
log_level = 'INFO'
load_from = None
resume_from = None
...
evaluation = dict(
    interval=5,
    metric='PCKh',
    metric_options=dict(threshold=0.5),
    save_best='PCKh'
)
...
model = dict(
    type='PCT',
    pretrained='C:/Users/ngovi/Desktop/PCT/weights/heatmap/swin_large.pth',
    backbone=dict(
    ...
    keypoint_head=dict(
        ...
        tokenizer=dict(
            guide_ratio=0.5,
            ckpt="C:/Users/ngovi/Desktop/PCT/work_dirs/pct_large_tokenizer/epoch_50.pth",
            encoder=dict(
                drop_rate=0.2,
                num_blocks=4,
                hidden_dim=512,
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='C:/Users/ngovi/Desktop/PCT/annot/train.json',
        img_prefix='C:/Users/ngovi/Desktop/images',
        data_cfg=data_cfg,
        pipeline=train_pipeline,
        dataset_info={{_base_.dataset_info}}),
    val=dict(
        type='TopDownMpiiDataset',
        ann_file='C:/Users/ngovi/Desktop/PCT/annot/valid.json',
        img_prefix='C:/Users/ngovi/Desktop/images',
        data_cfg=data_cfg,
    ...
    test=dict(
        type='TopDownMpiiDataset',
        ann_file='C:/Users/ngovi/Desktop/PCT/annot/test.json',
        img_prefix='C:/Users/ngovi/Desktop/images',
        data_cfg=data_cfg,
        pipeline=val_pipeline,
        dataset_info={{_base_.dataset_info}})
